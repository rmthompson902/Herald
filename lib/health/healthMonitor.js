...
class HealthMonitor extends EventEmitter {
  constructor(
    qlabProtocol,
    oscClient,
    { heartbeatIntervalMs = DEFAULT_HEARTBEAT_INTERVAL_MS, missThreshold = DEFAULT_MISS_THRESHOLD } = {}
  ) {
    super();
  ...
  async start() {
    ...
    try {
      ...
      // will keep retrying and will surface it via the normal miss-threshold path.
    }
